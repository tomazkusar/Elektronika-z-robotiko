...
'*******************************************************************************
'===========================================================+
'Nastavitve za analogne vhode - postaviš na 1 tisti vhod, ki ga uporabljaš
Const analogni_vhod_A0_enabled = 0
Const analogni_vhod_A1_enabled = 0
Const analogni_vhod_A2_enabled = 1
Const analogni_vhod_A3_enabled = 0
Const analogni_vhod_A4_enabled = 0
Const analogni_vhod_A5_enabled = 0
...
'-----------------------------------------------------------+                                            '
   ...
   #if analogni_vhod_A0_enabled = 1
   PORTC.0 = 0
   #endif
    #if analogni_vhod_A1_enabled = 1
   PORTC.1 = 0
   #endif
    #if analogni_vhod_A2_enabled = 1
   PORTC.2 = 0
   #endif
    #if analogni_vhod_A3_enabled = 1
   PORTC.3 = 0
   #endif
    #if analogni_vhod_A4_enabled = 1
   PORTC.4 = 0
   #endif
    #if analogni_vhod_A5_enabled = 1
   PORTC.5 = 0
   #endif
